...
public class MainActivity extends Activity {
	...
	private int[] selectedIds = { R.drawable.avft_active,
			R.drawable.box_stack_active, R.drawable.bubble_active,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for(int i =0;i<drawable.length;i++){
			drawable[i]=new RevealDrawable(getResources()
					.getDrawable(unSelectedIds[i]), getResources().getDrawable(
					selectedIds[i]), RevealDrawable.HORIZONTAL);
		}
